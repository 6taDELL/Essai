...
public class TestJoueur {
	...
	public void test2() {
		...
		Test.test(joueur.nbPieces() == 3,"test de l'ajout d'un nombre de piéces");
		joueur.ajouterPieces(-2);
		Test.test(joueur.nbPieces() == 3,"test d'ajout d'un nombre de piéces négatif");
		joueur.retirerPieces(-1);
		Test.test(joueur.nbPieces() == 3,"test d'un retrait d'un nombre négatif de piéces");
		joueur.retirerPieces(4);
		Test.test(joueur.nbPieces() == 3,"test de retrait d'un trop grand nombre de piéces");
		joueur.retirerPieces(2);
		joueur.retirerPieces(1);
		Test.test(joueur.nbPieces() == 0,"test de retrait d'un nombre de piéces");
	}
